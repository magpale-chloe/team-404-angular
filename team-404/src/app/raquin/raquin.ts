...
export class Raquin {
  ...
  description = signal(
    'I am Renz Mathieu M. Raquin, a 4th year IT student with a passion for web' +
    ' development and software engineering. I aspire to create systems that ' +
    'can make a positive impact to society.'
  );
